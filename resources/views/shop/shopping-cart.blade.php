                                ...
                                <div class="col-sm-10 col-md-10 col-md-offset-1 col-sm-offset-2">
                                    ...
                                    <div class="post__author">                                
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><img src="https://ucarecdn.com/a414ad0a-be9f-4404-8bde-1bdf7444d297/visabankcardicon33715.png" height="50"><span class="pull-right"> <a href="{{ route('checkout') }}" type="button" class="btn btn-success pull-left"><i class="fa fa-cc-visa" aria-hidden="true"></i> {{ trans('shop.visa') }}</a></span><center><h6>{!! trans('checkout.checkoutconenvio') !!}</h6></center></li>
                                            <li class="list-group-item"><img src="https://ucarecdn.com/1a9097c7-684e-4f92-877d-320a71371e1a/sgkb_einzahlungsschein_orange.jpg" height="35"><span class="pull-right"> <a href="{{ route('rechnung') }}" type="button" class="btn btn-success pull-right"><i class="fa fa-clipboard" aria-hidden="true"></i> {{ trans('shop.conti') }}</a></span><center><h6>{!! trans('checkout.rechnungconenvio') !!}</h6></center></li>
                                        </ul>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="post__author">                                
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><img src="https://ucarecdn.com/a414ad0a-be9f-4404-8bde-1bdf7444d297/visabankcardicon33715.png" height="50"><span class="pull-right"> <a href="{{ route('checkoutsin') }}" type="button" class="btn btn-success pull-left"><i class="fa fa-cc-visa" aria-hidden="true"></i> {{ trans('shop.visa') }}</a></span><center><h6>{!! trans('checkout.checkoutsinenvio') !!}</h6></center></li>
